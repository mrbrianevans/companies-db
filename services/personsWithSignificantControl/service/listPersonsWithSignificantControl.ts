 ...
 */
export async function listPersonsWithSignificantControl(company_number: string, items_per_page: string, start_index: string, register_view: string): Promise<ListPersonsWithSignificantControlResponse> {
